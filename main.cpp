...
void getSharedPtrStatus(SharedToyPtr* sharedToyPtr, string tag)
{
    cout << tag << " - control block address: " << sharedToyPtr->getCheckBlock() << ", toy address: " << sharedToyPtr->get() << " links: " << sharedToyPtr->getUseCount() << "\n";
}
